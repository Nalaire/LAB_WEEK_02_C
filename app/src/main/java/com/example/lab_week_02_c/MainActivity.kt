...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        findViewById<View>(R.id.button_standard).setOnClickListener(buttonClickListener)
        findViewById<View>(R.id.button_single_top).setOnClickListener(buttonClickListener)
    }
}